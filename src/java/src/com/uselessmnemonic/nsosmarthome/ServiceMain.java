package com.uselessmnemonic.nsosmarthome;
...
import com.uselessmnemonic.nsosmarthome.namespaces.*;
import com.tailf.dp.*;
...
public class ServiceMain {
    ...
    @ServiceCallback(servicePoint="nso-smart-home-servicepoint",
     ...
     */
    @ActionCallback(callPoint="nso-smart-home-self-test", callType=ActionCBType.INIT)
     ...
     */
    @ActionCallback(callPoint="nso-smart-home-self-test", callType=ActionCBType.ACTION)
    public ConfXMLParam[] selftest(DpActionTrans trans, ConfTag name,
                                   ConfObject[] kp, ConfXMLParam[] params)
    throws DpCallbackException {
        try {
            // Refer to the service yang model prefix
            String nsPrefix = "nso-smart-home";
